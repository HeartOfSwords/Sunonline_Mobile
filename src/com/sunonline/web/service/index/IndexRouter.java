...
public class IndexRouter extends HttpServlet {
	...
	private void getVideoInfos(HttpServletRequest request) {
		...
		//获取Higo列表
		List<HigoVideoBean> higoVideoBeans = indexInfoDao.fetchHigoList(3);
		//获取最强音列表
		List<CollegeVoiceVideoBean> collegeVoiceVideoBeans = indexInfoDao.fetchCollegeVoiceList(3);
		//获取老司机列表
		List<OldDriverVideoBean> oldDriverVideoBeans = indexInfoDao.fetchOldDriverList(4);
		//获取mooc信息
