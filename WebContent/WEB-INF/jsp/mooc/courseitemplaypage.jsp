		...
		<div class="container">
			<div class="row">
				<div class="col-sm-12 col-md-12">
					...
					%>
						<video class="full" width="100%" height="100%" src="<%=cl_video_url %>" controls="controls" poster="<%=cl_pic_url %>">
						</video>
					<%} %>
					</div>
				</div>
				...
				<div role="tabpanel" class="tab-pane fade in active" id="video-intro">
					...
					<div class="panel panel-default">
						<div class="panel-body">
							<strong>课程名称</strong>：<%=cl_name %>
						</div>
					</div>
					<div class="panel panel-default">
						<div class="panel-body">
							<strong>课程讲师</strong>：<%=coursesBean.getC_teacher_name() %>
						</div>
					</div>
					<div class="panel panel-default">
						<div class="panel-body">
							<strong>讲师简介</strong>：<%=coursesBean.getC_teacher_intro() %>
						</div>
					</div>
				</div>
