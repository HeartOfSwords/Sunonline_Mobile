...
<html lang="en">
	...
	<%
		List<OldDriverVideoBean> oldDriverVideoBeans = (List<OldDriverVideoBean>) request
				.getAttribute("oldDriverVideoList");
	...
	<div class="panel panel-default">
		<a
			href="OldDriverVideoPlayPage?id=<%=oldDriverVideoBean.getLSJ_video_id()%>"
			class="HOC-panel-a">
			<div class="panel-body">
				<div class="HOC-panel-pic">
					<img src="<%=oldDriverVideoBean.getLSJ_video_pic_url()%>" />
				</div>
				<div class="HOC-panel-title">
					<%=oldDriverVideoBean.getLSJ_video_name()%>
				</div>
			</div>
		</a>
	</div>
	...
	<!--分页按钮部分开始-->
		<div class="page_roll HOC-page-roll">
			...
			<button type="button" class="btn btn-default"
				onclick="window.location.href='OldDriverPager?current_pageno=1'">
				<span class="glyphicon glyphicon-home">首页</span></a>
			</button>
			<button type="button" class="btn btn-default"
				onclick="window.location.href='OldDriverPager?current_pageno=<%=oldDriverPagerBean.getCurPage() - 1%>'">
			...
			<button type="button" class="btn btn-default"
				...
				onclick="window.location.href='OldDriverPager?current_pageno=<%=oldDriverPagerBean.getMaxPage()%>'">
