...
<html lang="en">
	...
	<body>
		...
		<!--单个视频模块开始-->
	<%
		List<CollegeVoiceVideoBean> collegeVoiceVideoBeans = (List<CollegeVoiceVideoBean>) request
				.getAttribute("collegeVoiceVideoList");
	...
	<div class="panel panel-default">
		<a href="CollegeVoiceVideoPlayPage?id=<%=collegeVoiceVideoBean.getZqy_video_id()%>" class="HOC-panel-a">
			<div class="panel-body">
				<div class="HOC-panel-pic">
					<img src="<%=collegeVoiceVideoBean.getZqy_video_pic_url() %>" />
				</div>
				<div class="HOC-panel-title"><%=collegeVoiceVideoBean.getZqy_video_name()%></div>
			</div>
		</a>
	</div>
	<%
